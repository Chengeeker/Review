...
void main() {
  group('FontWeight Adjustment Tests', () {
    ...
    test('Positive adjustment increases font weight', () {
      ...
      expect(AppTheme.adjustFontWeight(FontWeight.bold, 300),
          FontWeight.w900); // Clamped at w900
    });
    ...
    test('ThemeData adjusts all textTheme styles with fontWeightAdjustment',
      ...
      expect(
          lightTheme0.appBarTheme.titleTextStyle?.fontWeight, FontWeight.w700);
      ...
      expect(
          darkTheme300.appBarTheme.titleTextStyle?.fontWeight, FontWeight.w900);
    });
