...
class ApiConstants {
  ...
  static const String hotMine = '/ajax/statuses/mineBand';
  static const String hotEntertainment = '/ajax/statuses/entertainment';
  static const String hotSocial = '/ajax/statuses/social';
  static const String hotTechnology = '/ajax/statuses/technology';
  static const String hotLife = '/ajax/statuses/life';
  static const String hotSport = '/ajax/statuses/sport';
  static const String hotAcg = '/ajax/statuses/acg';
  static const String hotBand = '/ajax/statuses/hot_band';

  /// Web 热搜页实际使用的榜单接口，键名与 HotTrendsView 的分类键一致。
  static const Map<String, String> hotTrendCategoryEndpoints = {
    'mine': hotMine,
    'hot': hotSearch,
    'ent': hotEntertainment,
    'social': hotSocial,
    'tech': hotTechnology,
    'life': hotLife,
    'sports': hotSport,
  ...
  static const String setVote = '/ajax/statuses/setVote';
